...
value in `stETH` does. Internally, it represents the user's [share](/docs/guías/lido-tokens-integration-guide.md#steth-internals-share-mechanics) of the total
